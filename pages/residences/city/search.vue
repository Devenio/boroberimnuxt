  ...
  export default {
    ...
    methods: {
      ...
      async changeOrder(order) {
        ...
        const { data } = await this.$axios.post(`api/v1/citiesResidences`,this.form);
      ...
      async search() {
        this.residences = [];
        this.showMore = true;
        const { data } = await this.$axios.post(`api/v1/citiesResidences2`,this.form);
        this.residences = data.data.residences;
        this.total = data.data.total;
      },
      async more() {
