<template>
  <header class="header">
    ...
    <no-ssr>
      <nav class="menu" uk-sticky="bottom: .footer">
        ...
        <div class="search"> <i class="bx bx-current-location right-input"></i>
          <input placeholder="دنبال چی میگردی ؟" v-model="title" />
    ...
    <div class="header__responsive">
      <div class="header__responsive-collapse" :class="[vuexMenuState ? 'active' : '',vuexLogregMobileState ? 'blur' : '']">
        <div class="collapse-menu">
          ...
          <div class="date-phone-login">
            <ul>
              ...
              <li v-else>
                <a href="javascript:void(0)" @click="logout" class="uk-text-danger"> <i class="bx bx-exit"></i> خروج </a>
              </li>
      ...
      <div class="header__responsive-show">
        <div>
          <a href="javascript:void(0)" class="test" @click="openMenu">
        ...
        <form @submit.prevent="">
          <input type="text" v-model="title" placeholder="دنبال چی میگردی ؟" />
    ...
    <vk-modal id="logreg" :show.sync="vuexLogregState">
      ...
      <div v-if="rlStatus === 3">
        ...
        <form @submit.prevent="">
          ...
          <div class="form-group" v-show="affiliateInput">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openMenu() {
        if(this.vuexMenuState === true) {
          this.$store.dispatch('setVuexMenuState',false);
        } else {
          this.$store.dispatch('setVuexMenuState',true);
        }
      },
      openLogreg() {
