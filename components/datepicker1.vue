<template>
  <div @dateselected="handleDateSelected" class="wraper flex">
    <div
      :class="[
        { 'dp-w-sm': size == 'sm' },
        { 'dp-w-md': size == 'md' },
    ...
    >
      ...
      >
        ...
        >
          <svg
            :class="{ flipH: locale === 'Jalali' }"
            class="
              dp-h-full dp-w-5 dp-text-sm dp-pointer-events-none
              dp-focus:outline-none
              p-1
            "
            viewBox="0 0 24 24"
      ...
      <div :class="{ rtl: locale === 'Jalali' }" class="calander">
      ...
      <div class="p-1 mt-2 flex flex-col rtl text-sm">
        <div class="flex flex-row items-center mt-1">
          <div class="relative overflow-hidden w-6 h-6 rounded dp-bg-secondary">
            <div
              class="
                absolute
                top-0
          ...
          <span class="mx-4"> تحویل فوری</span>
        </div>
        <div class="flex flex-row items-center mt-1">
          <div class="relative overflow-hidden w-6 h-6 rounded dp-bg-secondary">
            <div
          ...
          <span class="mx-4"> پیک مسافرت</span>
        </div>
      </div>
    </div>
    <div
...
<style scoped>
 ...
 .calander {
  ...
  .dp-sii {
    ...
    --ttw-scale-x: 1;
    --ttw-scale-y: 1;
    transform: translateX(var(--ttw-translate-x)) translateY(var(--ttw-translate-y)) rotate(var(--ttw-rotate)) skewX(var(--ttw-skew-x)) skewY(var(--ttw-skew-y)) scaleX(var(--ttw-scale-x)) scaleY(var(--ttw-scale-y));
    --ttw-translate-x: -50%;
  }
